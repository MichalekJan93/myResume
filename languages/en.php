<?php
    $langNav = array(
        ...
        "profile" => '
                    ...
                    <br /><br />
                    For a better presentation, I have prepared a sample of my work for you. I designed a simple web application with basic functions and SQL database management for the insurance industry. It is a single-page application that uses vanilla JS for all work with the DOM.
