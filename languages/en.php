<?php
    $langNav = array(
        ...
        "profile" => '
                    <p>Hi, <br /><br />
                    i&apos;m an avid self-taught front-end web developer and programming has been a passion of mine since high school. For the last year and a half, I have been actively learning front-end programming in JavaScript, TypeScript, and recently I immersed myself in React and React native, in which I would like to create web and mobile applications in the future. <br /><br /> 
                    In order to improve my programming skills, I successfully completed the web application programmer retraining course at <a href="https://www.itnetwork.cz/">ITNetwork</a>. After working in the electrical field, I am looking for my first job opportunity as a front-end junior programmer.
                    <br /><br />
